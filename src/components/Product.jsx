...
const Product = ({post}) => {
  ...
  const addToCart=()=>{
    //add function of slice
    dispatch(add(post));
    toast.success("Item Added To Cart");
  }

  const removeFromCart=()=>{
    //remove function of slice
  ...
  return (
    ...
    hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] hover:shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]">
